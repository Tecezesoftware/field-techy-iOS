...
class EngineerSignUpContainerVC: UIViewController {
    ...
    private func makeStepVC(step: Int) -> BaseStepVC {
        let storyboard = UIStoryboard(name: "EngineerSignUpContainer", bundle: nil)
        
        let identifier: String
        switch step {
        case 0: identifier = "EngineerStep1VC"
        case 1: identifier = "EngineerStep2VC"
        case 2: identifier = "EngineerStep3VC"
        default: identifier = "EngineerStep1VC"
        }
        ...
        // Pass shared model
        vc.sharedModel = sharedModel
        return vc
    }
    // Step ViewControllers
    private lazy var step1VC: BaseStepVC = makeStepVC(step: 0)
    private lazy var step2VC: BaseStepVC = makeStepVC(step: 1)
    private lazy var step3VC: BaseStepVC = makeStepVC(step: 2)
